...
public abstract class HeaderRecyclerAndFooterWrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected MyBaseAdapter mInnerAdapter;//内部的的普通Adapter

    public HeaderRecyclerAndFooterWrapperAdapter(MyBaseAdapter mInnerAdapter) {
    ...
    public void addHeaderView(int layoutId, Object data) {
        ...
        try{
            mInnerAdapter.setHeaderViewsCount(getHeaderViewCount());
        }catch (Exception e){}
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        mInnerAdapter.onBindViewHolder((MyBaseAdapter.BaseViewHolder) holder, position - getHeaderViewCount());
    }
...
//        mInnerAdapter.onViewAttachedToWindow((MyBaseAdapter.BaseViewHolder) holder);
