package com.yanxuwen.PinnedHeader.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        ...
        paddingLeft= DensityUtil.dip2px(context,15);
    }
    ...
    public SuspensionDecoration setPaddingLeft(int paddingLeft){
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft()+paddingLeft, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
