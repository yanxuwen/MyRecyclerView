package com.yanxuwen.PinnedHeader.IndexBar.widget;
...
import com.yanxuwen.PinnedHeader.IndexBar.helper.IIndexBarDataHelper;
import com.yanxuwen.PinnedHeader.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            }else if(attr == R.styleable.IndexBar_textColor){
    ...
    /**
     * 设置悬停头部如A，B,C,D，要在setSourceDatas之前调用
     * @param mDecoration
     * @return
     */
    public IndexBar setSuspensionDecoration(SuspensionDecoration mDecoration){
        this.mDecoration=mDecoration;
        return this;
    }

    /**
     * 设置是否排序，不排序隐藏所有的索引.要在setSourceDatas之前调用
     * @param isSort
     * @return
     */
    public IndexBar setIsSort(boolean isSort){
        this.isSort=isSort;
        return this;
    }
     ...
     * 设置是否显示索引
     */
    public IndexBar setIsShowIndex(boolean isShowIndex){
